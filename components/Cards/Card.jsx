        ...
        rounded-tl-[8px] rounded-tr-[8px]"
          >
            <div className="flex gap-2">
              ...
              <h3 className="text-lg font-semibold text-primary">
                {type === "experience"
                  ? qualification // FIXED: `qualification` instead of `position`
                  : type === "education"
                  ? company // FIXED: Use `company`
                  : duration}
              </h3>
            </div>
          ...
          <div>
            <div className="flex-1 flex items-center justify-center xl:justify-start md:py-8 md:px-16">
              <div className=" flex flex-col xl:flex-row items-center xl:items-start gap-4 text-center xl:text-left xl:gap px-4 xl:px-0">
                {type === "skill" ? (
                  ...
                  <div className="relative w-[300px] h-[100px] xl:h-[44px]">
                    <Image
                      src={logoUrl}
                      width={175} // FIXED: Explicitly set width
                      height={50} // FIXED: Explicitly set height
                      alt=""
                ...
                <div
                  className=" xl:border-l xl:border-secondary/10 xl:pl-12
                 w-full"
                >
